//============================================================-
//CCntCLI.H
// C++/CLI Headder file for CONTEC Counter device
//
//                                              CONTEC.Co.,Ltd.
//============================================================-
#pragma once
...
namespace CCntCLI
{
	...
	public delegate void PSAMPLINGSTOPCALLBACK(short Id, int wParam, int lParam, void *Param);
	public delegate void PSAMPLINGCOUNTCALLBACK(short Id, int wParam, int lParam, void *Param);

	//-------------------------------------------------
	// Prototype definition
	//-------------------------------------------------
	// Common function
	[DllImport("ccnt.dll")] long CntInit(String^ DeviceName, short *Id);
	[DllImport("ccnt.dll")] long CntExit(short Id);
	[DllImport("ccnt.dll")] long CntResetDevice(short Id);
	[DllImport("ccnt.dll")] long CntGetErrorString(int ErrorCode , StringBuilder^ ErrorString);
	// Setting function (set)
	[DllImport("ccnt.dll")] long CntSetZMode(short Id, short ChNo, short Mode);
	[DllImport("ccnt.dll")] long CntSetZLogic(short Id, short ChNo, short ZLogic);
	[DllImport("ccnt.dll")] long CntSelectChannelSignal(short Id, short ChNo, short SigType);
	[DllImport("ccnt.dll")] long CntSetCountDirection(short Id, short ChNo, short Dir);
	[DllImport("ccnt.dll")] long CntSetOperationMode(short Id, short ChNo, short Phase, short Mul, short SyncClr);
	[DllImport("ccnt.dll")] long CntSetDigitalFilter(short Id, short ChNo, short FilterValue);
	[DllImport("ccnt.dll")] long CntSetPulseWidth(short Id, short ChNo, short PlsWidth);
	[DllImport("ccnt.dll")] long CntSetDIType(short Id, short ChNo, short InputType);
	[DllImport("ccnt.dll")] long CntSetOutputHardwareEvent(short Id, short ChNo, short OutputLogic, unsigned long EventType, short PulseWidth);
	[DllImport("ccnt.dll")] long CntSetInputHardwareEvent(short Id, short ChNo, unsigned long EventType, short RF0, short RF1, short Reserved);
	[DllImport("ccnt.dll")] long CntSetCountMatchHardwareEvent(short Id, short ChNo, short RegisterNo, unsigned long EventType, short Reserved);
	[DllImport("ccnt.dll")] long CntSetPresetRegister(short Id, short ChNo, unsigned long PresetData, short Reserved);
	// Setting function (get)
	[DllImport("ccnt.dll")] long CntGetZMode(short Id, short ChNo, short *Mode);
	[DllImport("ccnt.dll")] long CntGetZLogic(short Id, short ChNo, short *ZLogic);
	[DllImport("ccnt.dll")] long CntGetChannelSignal(short Id, short ChNo, short *SigType);
	[DllImport("ccnt.dll")] long CntGetCountDirection(short Id, short ChNo, short *Dir);
	[DllImport("ccnt.dll")] long CntGetOperationMode(short Id, short ChNo, short *Phase, short *Mul, short *SyncClr);
	[DllImport("ccnt.dll")] long CntGetDigitalFilter(short Id, short ChNo, short *FilterValue);
	[DllImport("ccnt.dll")] long CntGetPulseWidth(short Id, short ChNo, short *PlsWidth);
	// Counter function
	[DllImport("ccnt.dll")] long CntStartCount(short Id, short *ChNo, short ChNum);
	[DllImport("ccnt.dll")] long CntStopCount(short Id, short *ChNo, short ChNum);
	[DllImport("ccnt.dll")] long CntPreset(short Id, short *ChNo, short ChNum, unsigned long *PresetData);
	[DllImport("ccnt.dll")] long CntZeroClearCount(short Id, short *ChNo, short ChNum);
	[DllImport("ccnt.dll")] long CntReadCount(short Id, short *ChNo, short ChNum, unsigned long *CntDat);
	[DllImport("ccnt.dll")] long CntReadStatus(short Id, short ChNo, short *Sts);
	[DllImport("ccnt.dll")] long CntReadStatusEx(short Id, short ChNo, unsigned long *Sts);
	// Notify function
	[DllImport("ccnt.dll")] long CntNotifyCountUp(short Id, short ChNo, short RegNo, unsigned long Count, int hWnd);
	[DllImport("ccnt.dll")] long CntStopNotifyCountUp(short Id, short ChNo, short RegNo);
	[DllImport("ccnt.dll")] long CntCountUpCallbackProc(short Id , IntPtr CallBackProc, void *Param);
	[DllImport("ccnt.dll")] long CntNotifyCounterError(short Id, int hWnd);
	[DllImport("ccnt.dll")] long CntStopNotifyCounterError(short Id);
	[DllImport("ccnt.dll")] long CntCounterErrorCallbackProc(short Id , IntPtr CallBackProc , void *Param);
	[DllImport("ccnt.dll")] long CntNotifyCarryBorrow(short Id, int hWnd);
	[DllImport("ccnt.dll")] long CntStopNotifyCarryBorrow(short Id);
	[DllImport("ccnt.dll")] long CntCarryBorrowCallbackProc(short Id, IntPtr CallBackProc, void *Param);
	[DllImport("ccnt.dll")] long CntNotifyTimer(short Id, unsigned long TimeValue, int hWnd);
	[DllImport("ccnt.dll")] long CntStopNotifyTimer(short Id);
	[DllImport("ccnt.dll")] long CntTimerCallbackProc(short Id , IntPtr CallBackProc , void *Param);
	// General purpose input function
	[DllImport("ccnt.dll")] long CntInputDIByte(short Id, short Reserved, Byte *bData);
	[DllImport("ccnt.dll")] long CntOutputDOBit(short Id, short ChNo, short Reserved, Byte OutData);
	// Information function
	[DllImport("ccnt.dll")] long CntQueryDeviceName(short Index, StringBuilder^ DeviceName, StringBuilder^ Device);
	[DllImport("ccnt.dll")] long CntGetMaxChannels(short Id, short *ChannelNum);
	[DllImport("ccnt.dll")] long CntGetDeviceInfo(String^ Device, short InfoType, int *Param1, int *Param2, int *Param3);
	// Test function
	[DllImport("ccnt.dll")] long CntSetTestPulse(short Id, short Internal, short Out, unsigned long Reserved);
	// Sampling mode function
	[DllImport("ccnt.dll")] long CntSetSyncSignal(short Id, short StartSignal, short StopSignal, short ClockSignal);
	[DllImport("ccnt.dll")] long CntSetStandAlone(short Id);
	[DllImport("ccnt.dll")] long CntSetMaster(short Id, short ExtSig1, short ExtSig2, short ExtSig3, short MasterHalt, short SlaveHalt);
	[DllImport("ccnt.dll")] long CntSetSlave(short Id, short ExtSig1, short ExtSig2, short ExtSig3, short MasterHalt, short SlaveHalt);
	[DllImport("ccnt.dll")] long CntSetCounterMode(short Id, short ChNo, short CountMode);
	// Sampling condition function
	[DllImport("ccnt.dll")] long CntSetSamplingStartTrigger(short Id, short StartTrg, short CountStartMode, short CountChNum);
	[DllImport("ccnt.dll")] long CntSetSamplingClockTrigger(short Id, short ClockTrg);
	[DllImport("ccnt.dll")] long CntSetSamplingStopTrigger(short Id, short StopTrg, short CountStopMode, short CountChNum);
	[DllImport("ccnt.dll")] long CntSetSamplingInternalClock(short Id, unsigned long Clock, short Unit);
	[DllImport("ccnt.dll")] long CntSetSamplingStopNumber(short Id, unsigned long StopNum);
	// Sampling message function
	[DllImport("ccnt.dll")] long CntNotifySamplingStop(short Id, int hWnd);
	[DllImport("ccnt.dll")] long CntSamplingStopCallbackProc(short Id, IntPtr CallBackProc, void *Param);
	[DllImport("ccnt.dll")] long CntNotifySamplingCount(short Id, long Count, int hWnd);
	[DllImport("ccnt.dll")] long CntSamplingCountCallbackProc(short Id, IntPtr CallBackProc, void *Param);
	// Sampling operation function
	[DllImport("ccnt.dll")] long CntSamplingFifoReset(short Id);
	[DllImport("ccnt.dll")] long CntSamplingSetBuffer(short Id, IntPtr Buffer, short ChNum, unsigned long ScanNum, short IsRing);
	[DllImport("ccnt.dll")] long CntSamplingStart(short Id);
	[DllImport("ccnt.dll")] long CntSamplingStop(short Id);
	// Sampling status function
	[DllImport("ccnt.dll")] long CntGetSamplingStatus(short Id, unsigned long *Status, unsigned long *Err);
	[DllImport("ccnt.dll")] long CntGetSamplingCount(short Id, unsigned long *ScanCount, unsigned long *ScanCarry);
	[DllImport("ccnt.dll")] long CntGetSamplingWritePointer(short Id, unsigned long *WritePointer, unsigned long *ScanCount, unsigned long *ScanCarry);
