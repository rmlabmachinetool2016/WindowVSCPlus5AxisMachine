...
namespace define{
	...
	static const unsigned int MAX_COUNT = 60001;	// simulation count
	...
	static const double INIT_POS_X		= 0,					// initial position(m,rad)
						INIT_POS_Y1		= 0.01,//-0.01,	//“ñŽŸŒ³‚ÌŽž‚Í‚±‚ê
						INIT_POS_Y2		= INIT_POS_Y1,
						INIT_POS_Z		= -0.01,//-0.010,
						INIT_ANGLE_C	= 0,
						INIT_ANGLE_A1	= 0,
	...
	static const double SAMPLING_TIME				= 0.002;				// sec
	...
	static const char *label[]={
		...
		"rpos(a2)","rvel(a2)","racc(a2)","pos(a2)","vel(a2)","acc(a2)","t(a2)","ew(a2)","ƒ³t","ƒ³td"};
